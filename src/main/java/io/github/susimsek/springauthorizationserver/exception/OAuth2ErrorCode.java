...
public enum OAuth2ErrorCode {
    ...
    UNAUTHORIZED_CLIENT(OAuth2ErrorCodes.UNAUTHORIZED_CLIENT, HttpStatus.UNAUTHORIZED,
        "error.oauth2.unauthorized_client"),
    ACCESS_DENIED(OAuth2ErrorCodes.ACCESS_DENIED, HttpStatus.FORBIDDEN, "error.oauth2.access_denied"),
    UNSUPPORTED_RESPONSE_TYPE(OAuth2ErrorCodes.UNSUPPORTED_RESPONSE_TYPE, HttpStatus.BAD_REQUEST,
        "error.oauth2.unsupported_response_type"),
    ...
    TEMPORARILY_UNAVAILABLE(OAuth2ErrorCodes.TEMPORARILY_UNAVAILABLE, HttpStatus.SERVICE_UNAVAILABLE,
        "error.oauth2.temporarily_unavailable"),
    ...
    UNSUPPORTED_GRANT_TYPE(OAuth2ErrorCodes.UNSUPPORTED_GRANT_TYPE, HttpStatus.BAD_REQUEST,
        "error.oauth2.unsupported_grant_type"),
    UNSUPPORTED_TOKEN_TYPE(OAuth2ErrorCodes.UNSUPPORTED_TOKEN_TYPE, HttpStatus.BAD_REQUEST,
        "error.oauth2.unsupported_token_type"),
    INVALID_REDIRECT_URI(OAuth2ErrorCodes.INVALID_REDIRECT_URI, HttpStatus.BAD_REQUEST,
        "error.oauth2.invalid_redirect_uri"),
    ...
    UNSUPPORTED_MEDIA_TYPE("unsupported_media_type", HttpStatus.UNSUPPORTED_MEDIA_TYPE,
        "error.oauth2.unsupported_media_type"),
    ...
    UNSUPPORTED_API_VERSION("unsupported_api_version", HttpStatus.GATEWAY_TIMEOUT,
        "error.oauth2.unsupported_api_version");
