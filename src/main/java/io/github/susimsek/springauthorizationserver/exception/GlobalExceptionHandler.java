...
import static io.github.susimsek.springauthorizationserver.constant.RateLimitConstants.RATE_LIMIT_LIMIT_HEADER_NAME;
import static io.github.susimsek.springauthorizationserver.constant.RateLimitConstants.RATE_LIMIT_REMAINING_HEADER_NAME;
import static io.github.susimsek.springauthorizationserver.constant.RateLimitConstants.RATE_LIMIT_RESET_HEADER_NAME;

import io.github.susimsek.springauthorizationserver.exception.ratelimit.RateLimitExceededException;
import io.github.susimsek.springauthorizationserver.exception.versioning.UnsupportedApiVersionException;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMaxUploadSizeExceededException(
        ...
        @NonNull HttpStatusCode status,
        @NonNull WebRequest request) {
        OAuth2ErrorCode oAuth2ErrorCode = OAuth2ErrorCode.PAYLOAD_TOO_LARGE;
        return createProblemDetailResponse(ex, new OAuth2Error(oAuth2ErrorCode.errorCode()),
            oAuth2ErrorCode.httpStatus(), oAuth2ErrorCode.messageKey(),
            null, new HttpHeaders(), request);
    }
