...
public final class CacheName {
    ...
    public static final String OAUTH2_AUTHORIZATION_ENTITY_BY_SPECIFICATION_CACHE =
    ...
    public static final String OAUTH2_CLIENT_ENTITY_COUNT_BY_CLIENT_SECRET_CACHE =
