...
import static io.github.susimsek.springauthorizationserver.cache.CacheName.OAUTH2_KEY_ENTITY_BY_USE_CACHE;
...
public interface OAuth2KeyRepository extends JpaRepository<OAuth2KeyEntity, String> {
    ...
    @Cacheable(cacheNames = OAUTH2_KEY_ENTITY_BY_USE_CACHE)
    List<OAuth2KeyEntity> findByActiveAndUse(boolean active, String use);
}
