...
import static io.github.susimsek.springauthorizationserver.constant.Constants.SYSTEM;
...
@EnableJpaRepositories(basePackages = "io.github.susimsek.springauthorizationserver.repository")
@EnableJpaAuditing(
