...
public final class CacheName {
    ...
    public static final String OAUTH2_CLIENT_ENTITY_COUNT_BY_CLIENT_ID_CACHE = "oauth2ClientEntityCountByClientIdCache";
    public static final String OAUTH2_CLIENT_ENTITY_COUNT_BY_CLIENT_SECRET_CACHE = "oauth2ClientEntityCountByClientSecretCache";
