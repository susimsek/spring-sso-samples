...
### Wallet OAuth2 Client

Wallet client allows you to obtain a JWT access token using the `wallet` grant type. This is achieved by submitting blockchain wallet-specific details to the OAuth2 token endpoint.

#### Request Parameters:

- **grant_type:** `wallet`
- **wallet_address:** Your blockchain wallet address (e.g., `0xd680a12985d22d041911f666ed96f3c719cef69a`)
- **signature:** Signature generated by your wallet
- **message:** Original message signed by the wallet

#### Example cURL Request:

```bash
curl --request POST \
  --url http://localhost:7080/oauth2/token \
  --header 'Authorization: Basic d2FsbGV0LWNsaWVudDpzZWNyZXQ=' \
  --header 'Content-Type: application/x-www-form-urlencoded' \
  --data grant_type=wallet \
  --data wallet_address=0xd680a12985d22d041911f666ed96f3c719cef69a \
  --data signature=0xacf703a179af0787670ed8c2301d97cb4e95983cdb1669d0d3076643a712a16e276adeaba9a24f8d35b439733d49006d71ae882dc307fc2b973e22c7460a89121c \
  --data 'message=Test message from MetaMask'
```
